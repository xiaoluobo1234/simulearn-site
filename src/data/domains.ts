...
export const domains: Domain[] = [
  {
    ...
    sections: [
      ...
      section('theory', '知识点', '理解求解器背后的平衡、能量与稳定性。', ['弱形式与虚功原理', '单元与形函数', '能量守恒', '特征值与稳定性']),
  ...
  },
  {
    ...
    sections: [
      ...
      section('theory', '知识点', '从能量守恒理解温度场。', ['傅里叶定律', '热扩散方程', '无量纲数', '界面热阻']),
  ...
  },
  {
    ...
    sections: [
      ...
      section('theory', '知识点', '理解质量、动量与能量输运。', ['Navier–Stokes 方程', '边界层', '湍流尺度', '压降与换热关联式']),
  ...
  },
  {
    ...
    sections: [
      ...
      section('theory', '知识点', '理解界面守恒与时间尺度。', ['界面传递条件', '分区/整体算法', '松弛与稳定性', '误差传播']),
  ...
  },
  {
    ...
    sections: [
      ...
      section('theory', '知识点', '补齐半导体与封装跨尺度基础。', ['封装材料行为', '热失配与翘曲', '电子冷却', '载流子输运入门']),
