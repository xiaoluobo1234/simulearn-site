...
const apdlSeeds: TutorialSeed[] = [
  ...
  },
  {
    ...
    question: '从初级到进阶，APDL 学习中最需要深入理解的概念是什么？',
	  ...
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-advanced-summary',
	    title: 'APDL 进阶总结与工程实践',
	    description: '整合专项分析技术与工具方法论，从初级思维转向工程判断思维。',
	    prerequisites: ['apdl-summary'],
	    difficulty: '基础',
	    question: '从"会用软件"到"能判断结果"，最关键的思维转变是什么？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-math-intro',
	    title: 'APDL Math 矩阵入门',
	    description: '认识 *DMAT 和 *SMAT 命令，掌握矩阵创建、赋值、导入导出和内存管理。',
	    prerequisites: ['apdl-advanced-summary'],
	    difficulty: '基础',
	    question: '在 APDL 中直接操作刚度矩阵相比使用 ANSYS Workbench 有什么独特优势？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-math-operations',
	    title: 'APDL Math 矩阵运算',
	    description: '使用 *MOPER 进行乘法、求逆、求解和特征值运算，构建自定义求解器。',
	    prerequisites: ['apdl-math-intro'],
	    difficulty: '基础',
	    question: '如何利用 APDL Math 的矩阵运算功能进行模型降阶和灵敏度分析？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-verification',
	    title: '结果验证方法论',
	    description: '建立网格收敛性、解析解对比、力/能量平衡和物理合理性的四层验证体系。',
	    prerequisites: ['apdl-advanced-summary'],
	    difficulty: '基础',
	    question: '为什么单靠"与其他软件对比"不足以验证有限元分析结果？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-contact',
	    title: '接触分析进阶',
	    description: '掌握 CONTA17x + TARGE170 接触对定义、算法选择、收敛诊断与结果评估。',
	    prerequisites: ['apdl-advanced-summary'],
	    difficulty: '基础',
	    question: '增广拉格朗日法与纯罚函数法在接触分析中各有什么优劣？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-buckling',
	    title: '屈曲分析',
	    description: '理解线性屈曲（特征值）与非线性屈曲（弧长法），掌握初始缺陷引入和后屈曲评估。',
	    prerequisites: ['apdl-advanced-summary'],
	    difficulty: '基础',
	    question: '为什么线性屈曲分析给出的临界载荷通常偏于不安全？',
	  },
	  {
	    group: 'APDL 进阶',
	    id: 'apdl-submodeling',
	    title: '子模型技术',
	    description: '使用"全局粗网格 + 切割边界位移映射 + 局部细网格"三步法精确求解应力集中问题。',
	    prerequisites: ['apdl-advanced-summary'],
	    difficulty: '基础',
	    question: '切割边界为什么必须远离应力集中区，距离应该如何定量确定？',
	  },
];
